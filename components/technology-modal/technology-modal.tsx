...
import SwitchIcon from '../../atoms/switch-icon';
...
const TechnologyModal = ({ name, context }: TechnologyModalProps) => {
	...
	const [nextTechnologyIndex, prevTechnologyIndex] =
		findNextAndPrevIndex(choosenTechnology, technologies);
			...
			<Box addClass={styles.header} justify='space-between'>
				<Box align='center'>
					...
					<Box
						...
						align={
							choosenContent.fullName !== '' ? 'flex-start' : 'center'
						}
						justify='flex-start'
