...
const textContent = {
	...
	about: {
		par1:
			"My name is Damian Duszyński. I'm committed and self-motivated Front-end Developer with a great passion for UX/UI and web technologies.",
		par2:
			"I am looking  for new opportunities to work with digital products that solve real problems and ensuring a great user experience. Privately, a fan of football, and cycling.",
